            ...
            <div class="flexilist">
            	<div class="common-head">
                    <form action="javascript:searchOrder()" name="searchForm">
                        <div class="search">
                            <div class="input">
                                <input type="text" name="apply_sn" class="text nofocus" placeholder="<?php echo $this->_var['lang']['apply_sn']; ?>" autocomplete="off" /><input type="submit" value="" class="not_btn" />
                            </div>
                        </div>
                    </form>
					<div class="fl">
...
?>
							    ...
							    <td class="handle">
                                    <div class="tDiv a2">
                                        ...
                                        <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['apply_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>" class="btn_trash"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['remove']; ?></a>	
                                        <?php endif; ?>
                                    </div>
								</td>
								</tr>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <div  class="select_w145 imitate_select">
                                            ...
                                            <ul>
                                               <li><a href="javascript:;" data-value="-1"><?php echo $this->_var['lang']['select_please']; ?></a></li>
                                               <li><a href="javascript:;" data-value="0">无效</a></li>
                                               <li><a href="javascript:;" data-value="1">有效</a></li>
                                            </ul>
