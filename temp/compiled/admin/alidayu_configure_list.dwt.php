...
?>
                            <tr>
                                ...
                                <td class="handle">
                                    <div class="tDiv a2">
                                        <a href="alidayu_configure.php?act=edit&id=<?php echo $this->_var['note']['id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>" class="btn_edit"><i class="icon icon-edit"></i><?php echo $this->_var['lang']['edit']; ?></a>
                                        <a href="javascript:confirm_redirect('<?php echo $this->_var['lang']['remove_confirm']; ?>', 'alidayu_configure.php?act=remove&id=<?php echo $this->_var['note']['id']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"class="btn_trash"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['remove']; ?></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; else: ?>
