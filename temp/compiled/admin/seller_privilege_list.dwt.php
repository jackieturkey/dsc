...
<body class="iframe_body">
	<div class="warpper">
    	<div class="title">权限-<?php echo $this->_var['ur_here']; ?></div>
        <div class="content">
        	<div class="explanation" id="explanation">
            	<div class="ex_tit"><i class="sc_icon"></i><h4>操作提示</h4><span id="explanationZoom" title="收起提示"></span></div>
                <ul>
                	<li>该页面展示了所有入驻平台的商家管理员列表。</li>
                    <li>可手动添加管理员并分配权限、查看日志等操作。</li>
                    <li>可以输入用户名名称关键字进行搜索，侧边栏可进行高级搜索</li>
                </ul>
            </div>
            <div class="flexilist">
            	<!--商品分类列表-->
                <div class="common-head">
                    ...
                    <form action="javascript:searchList()" name="searchForm">
                        <div class="search">
                            <div class="input">
                                <input type="text" name="keywords" class="text nofocus" placeholder="用户名" autocomplete="off" /><input type="submit" value="" class="not_btn" />
                            </div>
                        </div>
                    </form>
                </div>
...
?>
                            	<tr>
                                    ...
                                    <td class="handle">
                                        <div class="tDiv a4">
                                            <a href="privilege_seller.php?act=allot&id=<?php echo $this->_var['list']['user_id']; ?>&user=<?php echo $this->_var['list']['user_name']; ?>" title="<?php echo $this->_var['lang']['allot_priv']; ?>" class="btn_region"><i class="icon icon-cog"></i><?php echo $this->_var['lang']['allot_priv']; ?></a>
                                            ...
                                            <a href="privilege_seller.php?act=edit&id=<?php echo $this->_var['list']['user_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>" class="btn_edit"><i class="icon icon-edit"></i><?php echo $this->_var['lang']['edit']; ?></a>
                                            <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['user_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>" class="btn_trash"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['remove']; ?></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; else: ?>
            ...
            <div class="gj_search">
                ...
                <div class="search-gao-bar">
                    <div id="searchBarClose" class="handle-btn"><i class="icon icon-zoom-out"></i>收起边栏</div>
...
?>
                        ...
                        <div class="bot_btn">
                            <input type="submit" value="提交查询" name="tj_search" class="btn red_btn"><input type="reset" value="重置" name="reset" class="btn btn_reset">
                        </div>
                    </form>
                </div>
            </div>
