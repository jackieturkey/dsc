            ...
            <div class="ex_tit">
                ...
                <div class="view-case">
                    ...
                    <div class="view-case-info">
                        <a href="http://help.ecmoban.com/article-5211.html" target="_blank">互亿短信配置使用说明</a>
                    </div>
                </div>			
                <?php endif; ?>				
            </div>
                            ...
                            <tr>
                                ...
                                <td class="handle">
                                    <div class="tDiv a2">
                                        ...
                                        <a href="javascript:confirm_redirect('<?php echo $this->_var['lang']['remove_confirm']; ?>', 'huyi_configure.php?act=remove&id=<?php echo $this->_var['note']['id']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"class="btn_trash"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['remove']; ?></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; else: ?>
